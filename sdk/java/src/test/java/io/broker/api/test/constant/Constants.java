...
public class Constants {
    ...
    // FIXME: please change to your valid api domain for test, for example: dsdaq.net
    public static final String BASE_DOMAIN = "";

    // REST api url format: https://api.BASE_DOMAIN
    // for example: https://api.dsdaq.net
    ...
    // for example: wss://wsapi.dsdaq.net/openapi/quote/ws/v1
    ...
    // for example: wss://wsapi.dsdaq.net/openapi/ws
